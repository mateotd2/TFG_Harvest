...
public class AuthenticationController implements AutenticadoApi {
    ...
    @Override
    public ResponseEntity<MessageResponseDTO> _changePassword(Long id, ChangePasswordDTO changePasswordDTO) throws InstanceNotFoundException, PermissionException, IncorrectPasswordException {
    ...
    @Override
    public ResponseEntity<MessageResponseDTO> _signUp(NewUserDTO newUserDTO) throws NoRoleException, DuplicateInstanceException {
