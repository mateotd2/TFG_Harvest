                ...
                showDialog(
                    ...
                    builder: (BuildContext context) {
                      return AlertDialog(
                        ...
                        content:
                            Text("Seguro que desea inicar la campaña anual?"),
                        actions: [
                          ElevatedButton(
                              onPressed: () {
                          ...
                          ElevatedButton(
                              onPressed: () async {
                                try {
                                  ...
                                  snackRed(
                                      context, 'Error al comenzar la campaña.');
                                }
                                Navigator.of(context).pop();
                              },
                              child: Text('Aceptar'))
          ...
          ElevatedButton(
              onPressed: () async {
                await Navigator.push(
                    ...
                    MaterialPageRoute(
                        builder: (context) =>
                            PendingTasks(typePhase: TypePhase.cleaning)));
              },
          ...
          ElevatedButton(
              onPressed: () async {
                await Navigator.push(
                    ...
                    MaterialPageRoute(
                        builder: (context) =>
                            PendingTasks(typePhase: TypePhase.pruning)));
              },
              // onPressed: () async {
              //   try {
          ...
          ElevatedButton(
              onPressed: () async {
                await Navigator.push(
                    ...
                    MaterialPageRoute(
                        builder: (context) =>
                            PendingTasks(typePhase: TypePhase.harvest)));
              },
